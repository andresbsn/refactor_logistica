...
import type { Route, AssignedRoute } from "@/types/ticket"

interface RouteSelectorProps {
  routes: (Route | AssignedRoute)[]
  selectedRoute: string | null
  onRouteChange: (routeId: string) => void
}

export function RouteSelector({ routes, selectedRoute, onRouteChange }: RouteSelectorProps) {
  if (routes.length === 0) {
    return (
