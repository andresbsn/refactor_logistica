import type { SubtypeConfig } from "@/types/ticket"

// Mapeo de tareas a materiales relacionados
export const taskMaterialsMap: Record<string, string[]> = {
  // Alumbrado
...
export const subtypeConfigs: Record<string, SubtypeConfig> = {
  // Alumbrado
  "Poste caído/torcido": {
    suggestedTasks: [
      "Evaluación de daños estructurales",
...
export function getSubtypeConfig(ticketTitle: string): SubtypeConfig {
  return subtypeConfigs[ticketTitle] || {
    suggestedTasks: ["Evaluación inicial", "Reparación", "Verificación final"],
    suggestedMaterials: [],
  }
}
